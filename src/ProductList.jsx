...
function ProductList({ onHomeClick }) {
    ...
    // Read cart from Redux to show item count in the icon and control button state
                                        ...
                                        <div>
                                            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                                                <h1 className='cart' style={{ position: 'relative', display: 'inline-block' }}>
                                                    ...
                                                    <span style={{ position: 'absolute', top: '-8px', right: '-8px', background: '#ff5722', color: '#fff', borderRadius: '50%', padding: '4px 8px', fontSize: '14px' }}>{totalCartItems}</span>
                                                </h1>
                                            </a>
                                        </div>
                </div>
                                ...
                                {category.plants.map((plant, plantIndex) => ( 
                                    <div className="product-card" key={plantIndex}> 
                                        ...
                                        <button
                                            ...
                                            disabled={cart.some(ci => ci.name === plant.name)}
                                            style={cart.some(ci => ci.name === plant.name) ? { opacity: 0.6, cursor: 'not-allowed' } : {}}
                                        >
                                            {cart.some(ci => ci.name === plant.name) ? 'Added to Cart' : 'Add to Cart'}
                                        </button>
                                    </div>
                                ))}
                            </div>
